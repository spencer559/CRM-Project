...
the form itself is in [report-generator.md](report-generator.md). Web paths here (`protected/`,
`src/`, `vendor/`, `tools/`, `mileage/`) are relative to `site/`, which is also their URL path.
